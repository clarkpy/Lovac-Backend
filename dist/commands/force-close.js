...
exports.forceClose = void 0;
const discord_js_1 = require("discord.js");
const data_source_1 = require("../data-source");
const Ticket_1 = require("../models/Ticket");
const logger_1 = __importDefault(require("../logger"));
const discord_bot_1 = require("../discord-bot");
const forceClose = (interaction) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = yield fetch(`${process.env.LOVAC_BACKEND_URL}/staff/check-staff`, {
            ...
            body: JSON.stringify({ staffId: assignee })
        });
        ...
        try {
            const response = yield fetch(`${process.env.LOVAC_BACKEND_URL}/api/force-close-ticket`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
                body: JSON.stringify({ staffId: assignee, ticketId: ticket.id, reason: `Closed by ${interaction.user.username}` })
            });
            const embed = new discord_js_1.EmbedBuilder()
                .setColor('#00ff00')
